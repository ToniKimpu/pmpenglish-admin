...
import { useCreatePatternExample } from "../../hooks/usePatternExample";

const CreatePatternExampleDialog = ({ patternId }) => {
  const [isOpen, setIsOpen] = useState(false);

  const { mutate: createPatternExample, isLoading: creating } =
    useCreatePatternExample(patternId);
...
export default CreatePatternExampleDialog;
